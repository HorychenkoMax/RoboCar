...
const int LeftDownForw     = 16;                              // left translation
const int LeftDownBack     = 32;                              // Right translation 
const int RightDownBack    = 1;                               // Upper left mobile
const int RightDownForw    = 8;                              // Lower left mobile
